...
VALUES (1, current_timestamp, current_timestamp, 'Answer1', true, 2, 1);

INSERT INTO answer_comments(id, created_date, modified_date, text, account_id, answer_id)
VALUES (1, current_timestamp, current_timestamp, 'AnswerComment1', 1, 1),
       (2, current_timestamp, current_timestamp, 'AnswerComment2', 1, 1),
       (3, current_timestamp, current_timestamp, 'AnswerComment3', 1, 1),
       (4, current_timestamp, current_timestamp, 'AnswerComment4', 1, 1),
       (5, current_timestamp, current_timestamp, 'AnswerComment5', 1, 1);
